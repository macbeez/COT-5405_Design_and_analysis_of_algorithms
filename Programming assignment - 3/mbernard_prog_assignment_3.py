...
# Checking to see if time taken to get the optimized solution is faster than time taken to get the 
# Brute Force solution for n = 1,2,3....10
sumO = 0
for i in range (0,10):
	sumO = sumO + duration[i]
print(sumO)

sumBF = 0
for i in range (0,10):
	sumBF = sumBF + duration_BruteForce[i]
print(sumBF)
