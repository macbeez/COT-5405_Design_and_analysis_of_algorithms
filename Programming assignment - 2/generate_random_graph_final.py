...
def run_sim(p, t=1000):
    ...
    for i, t in enumerate(numberOfNodes):
        ...
        print_progress(i+1, totalTime, prefix='p='+"{:0.2f}".format(p), suffix=" time = "+str(i+1)+"/"+str(totalTime)+", total nodes="+str(numberOfNodes[i])+", total edges="+str(sum(degrees)), decimals=2, bar_length=50)
